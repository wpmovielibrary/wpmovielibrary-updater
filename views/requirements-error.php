<div class="error">
	<p><?php _e( 'WPMovieLibrary-Details error: your environment does not meet all of the system requirements listed below.', 'wpmovielibrary' ); ?></p>

	<ul class="ul-disc">
		<li>
			<strong>PHP <?php echo WPMOLY_DETAILS_REQUIRED_PHP_VERSION; ?>+</strong>
			<em><?php printf( __( '(You\'re running version %s)', 'wpmovielibrary' ), PHP_VERSION ); ?></em>
		</li>
		<li>
			<strong>WordPress <?php echo WPMOLY_DETAILS_REQUIRED_WP_VERSION; ?>+</strong>
